...
function Model(props) {
  ...
  return (
    <group style={{backgroundColor:"red"}}  ref={group} {...props} dispose={null}>
      <group rotation-x={-0.425} position={[0, -0.04, 0.41]}>
        <group position={[0, 2.96, -0.13]} rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh geometry={nodes['Cube008_2'].geometry}>
            ...
            <Html className="content" style={{backgroundColor:"black",width:"100%"}}  rotation-x={-Math.PI / 2} position={[0, 0.05, -0.09]} transform occlude>
